...
const App: React.FC = () => {
  ...
  activeTabText: { color: isDark ? currentColors.primaryText : currentColors.buttonText },
    ...
    cardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 18, gap: 12 },
    cardTitle: { fontSize: 18, fontWeight: '700', color: currentColors.primaryText },
    inputContainer: { marginBottom: 18 },
    inputLabel: { color: currentColors.primaryText, opacity: 0.85, marginBottom: 8, fontSize: 14, fontWeight: '600' },
    input: { backgroundColor: currentColors.mainBackground, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 14, color: currentColors.primaryText, fontSize: 15 },
